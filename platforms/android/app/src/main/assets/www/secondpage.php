	  			...
	  			<div class="container">
			  		<div class="row align-items-center">
			  			...
			  			<div class="col-lg-6 col-sm-6 col-8 header-top-right">
							<a href="" id="bookbtn" class="primary-btn text-uppercase" onclick="//smoothScroll(document.getElementById('scrollHere'))">Book Appointment</a>
			  			</div>
			  		</div>			  					
	  			</div>
			</div>
			...
			<section class="appointment-area">			
				<div class="container">
					<div class="row justify-content-between align-items-center pb-120 appointment-wrap">
						...
						<div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60" id="scrollHere">
